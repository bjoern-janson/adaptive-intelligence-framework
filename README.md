...
A unified framework for studying intelligence as the capacity of adaptive systems to convert feedback into increased future viability.
...
- **Ω (Grounded Reachability)**  
  The set of future states the system can actually influence.

- **C (Correction Capacity)**  
  The ability of reality to modify the system through feedback.

- **A (Adaptation)**  
  The ability to update strategies, representations, and mechanisms.

- **R' (Improved Representation)**  
  A more capable internal model after adaptation.
...
Interfaces determine the computational space available to bounded agents.

## Computational Phase Boundaries

Capability jumps may occur when new regions of computational possibility become reachable.

## Resolution Horizon

Measures limits imposed by:
...
Studies representation change as a driver of discovery and efficiency.

## Computational Leverage

Measures when representation changes create disproportionate capability gains.
...
A system succeeds when residual capability remains after the system itself is gone.
...
- proof-of-concept simulators implemented
- experimental validation in progress

The goal is to identify the structural conditions under which adaptive systems begin modifying their own future learning capabilities.
