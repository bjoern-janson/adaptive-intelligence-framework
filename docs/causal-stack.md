...
Mechanisms are the active processes that transform states.
...
# 5. Mechanism Generator

The deepest adaptive layer is the ability to modify the mechanisms responsible for future adaptation.
...
| Mechanism Generator | Recursive Adaptive Dynamics |
| Selection Across Systems | Ancestor Architecture |
